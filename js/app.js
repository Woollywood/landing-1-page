 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            document.querySelectorAll(".projects-slider__item").forEach((slider => {
                new core(slider.querySelector(".projects-slider__body"), {
                    ...
                    parallax: true,
                    pagination: {
                        el: slider.querySelector(".projects-slider__item .slider__dotts"),
                        clickable: true
                    },
                    navigation: {
                        prevEl: slider.querySelector(".projects-slider__item .slider-arrow-prev"),
                        nextEl: slider.querySelector(".projects-slider__item .slider-arrow-next")
                    },
                    on: {}
                });
            }));
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.closest(".icon-menu")) document.querySelector(".header__menu").classList.toggle("_active");
            }
        };
        mixitup(".projects-slider", {
            load: {
                filter: ".category-all"
            }
        });
